...
class AzureRMTransparentDataEncryptions(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not response:
            ...
            if self.state == 'absent':
                ...
                to_be_updated = True
                if to_be_updated:
                    self.log('Deleting TransparentDataEncryptions instance before update')
    ...
    def create_update_sql(self):
        ...
        '''
        self.log("Creating / Updating the TransparentDataEncryptions instance {0}".format(self.server_name))
    ...
    def delete_sql(self):
        ...
        :return: True
        '''
        self.log("Deleting the TransparentDataEncryptions instance {0}".format(self.server_name))
        try:
    ...
    def get_sql(self):
        ...
        :return: deserialized TransparentDataEncryptions instance state dictionary
        '''
        self.log("Checking if the TransparentDataEncryptions instance {0} is present".format(self.server_name))
        found = False
        try:
