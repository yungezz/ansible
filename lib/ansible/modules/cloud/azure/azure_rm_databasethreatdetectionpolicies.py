...
EXAMPLES = '''
      - name: Create sample DatabaseSecurityAlertPolicies
...
class AzureRMDatabaseThreatDetectionPolicies(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not response:
            ...
            if self.state == 'absent':
                ...
                to_be_updated = True
                if to_be_updated:
                    self.log('Deleting DatabaseThreatDetectionPolicies instance before update')
    ...
    def create_update_databasesecurityalertpolicies(self):
        ...
        '''
        self.log("Creating / Updating the DatabaseThreatDetectionPolicies instance {0}".format(self.database_name))
    ...
    def delete_databasesecurityalertpolicies(self):
        ...
        :return: True
        '''
        self.log("Deleting the DatabaseThreatDetectionPolicies instance {0}".format(self.database_name))
        try:
    ...
    def get_databasesecurityalertpolicies(self):
        ...
        :return: deserialized DatabaseThreatDetectionPolicies instance state dictionary
        '''
        self.log("Checking if the DatabaseThreatDetectionPolicies instance {0} is present".format(self.database_name))
        found = False
        try:
