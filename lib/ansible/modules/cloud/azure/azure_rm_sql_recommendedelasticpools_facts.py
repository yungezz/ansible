...
DOCUMENTATION = '''
---
module: azure_rm_sql_recommendedelasticpools
version_added: "2.5"
...
EXAMPLES = '''
      - name: Create sample Sql
        azure_rm_sql_recommendedelasticpools:
'''
...
class AzureRMRecommendedElasticPoolsFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        '''
        self.log("Checking if the RecommendedElasticPools instance {0} is present".format(self.resource_group_name))
        found = False
        try:
