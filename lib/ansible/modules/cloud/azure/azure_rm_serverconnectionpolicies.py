...
EXAMPLES = '''
      - name: Create sample ConnectionPolicies
...
class AzureRMServerConnectionPolicies(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not response:
            ...
            if self.state == 'absent':
                ...
                to_be_updated = True
                if to_be_updated:
                    self.log('Deleting ServerConnectionPolicies instance before update')
    ...
    def create_update_connectionpolicies(self):
        ...
        '''
        self.log("Creating / Updating the ServerConnectionPolicies instance {0}".format(self.resource_group_name))
    ...
    def delete_connectionpolicies(self):
        ...
        :return: True
        '''
        self.log("Deleting the ServerConnectionPolicies instance {0}".format(self.resource_group_name))
        try:
    ...
    def get_connectionpolicies(self):
        ...
        :return: deserialized ServerConnectionPolicies instance state dictionary
        '''
        self.log("Checking if the ServerConnectionPolicies instance {0} is present".format(self.resource_group_name))
        found = False
        try:
