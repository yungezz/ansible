...
EXAMPLES = '''
      - name: Create sample DataMasking
...
class AzureRMDataMaskingPolicies(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not response:
            ...
            if self.state == 'absent':
                ...
                to_be_updated = True
                if to_be_updated:
                    self.log('Deleting DataMaskingPolicies instance before update')
    ...
    def create_update_datamasking(self):
        ...
        '''
        self.log("Creating / Updating the DataMaskingPolicies instance {0}".format(self.server_name))
    ...
    def delete_datamasking(self):
        ...
        :return: True
        '''
        self.log("Deleting the DataMaskingPolicies instance {0}".format(self.server_name))
        try:
    ...
    def get_datamasking(self):
        ...
        :return: deserialized DataMaskingPolicies instance state dictionary
        '''
        self.log("Checking if the DataMaskingPolicies instance {0} is present".format(self.server_name))
        found = False
        try:
