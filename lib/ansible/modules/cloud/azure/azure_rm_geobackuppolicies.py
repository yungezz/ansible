...
EXAMPLES = '''
      - name: Create sample GeoBackupPolicies
...
class AzureRMGeoBackupPolicies(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not response:
            ...
            if self.state == 'absent':
                ...
                to_be_updated = True
                if to_be_updated:
                    self.log('Deleting GeoBackupPolicies instance before update')
    ...
    def create_update_geobackuppolicies(self):
        ...
        '''
        self.log("Creating / Updating the GeoBackupPolicies instance {0}".format(self.server_name))
    ...
    def delete_geobackuppolicies(self):
        ...
        :return: True
        '''
        self.log("Deleting the GeoBackupPolicies instance {0}".format(self.server_name))
        try:
    ...
    def get_geobackuppolicies(self):
        ...
        :return: deserialized GeoBackupPolicies instance state dictionary
        '''
        self.log("Checking if the GeoBackupPolicies instance {0} is present".format(self.server_name))
        found = False
        try:
