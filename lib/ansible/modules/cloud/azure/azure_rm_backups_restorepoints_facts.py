...
DOCUMENTATION = '''
---
module: azure_rm_backups_restorepoints_facts
version_added: "2.5"
...
class AzureRMRestorePointsFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        super(AzureRMRestorePointsFacts, self).__init__(self.module_arg_spec)
    ...
    def list_by_database(self):
        ...
        found = False
        try:
            response = self.mgmt_client.restore_points.list_by_database(self.resource_group_name,
                                                                        self.server_name,
                                                                        self.database_name)
            found = True
