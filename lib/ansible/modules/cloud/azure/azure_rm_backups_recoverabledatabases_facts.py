...
DOCUMENTATION = '''
---
module: azure_rm_backups_recoverabledatabases
version_added: "2.5"
...
EXAMPLES = '''
      - name: Create sample Backups
        azure_rm_backups_recoverabledatabases:
'''
...
class AzureRMRecoverableDatabasesFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        '''
        self.log("Checking if the RecoverableDatabases instance {0} is present".format(self.resource_group_name))
        found = False
        try:
