...
class AzureRMServerCommunicationLinks(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not response:
            ...
            if self.state == 'absent':
                ...
                to_be_updated = True
                if to_be_updated:
                    self.log('Deleting ServerCommunicationLinks instance before update')
    ...
    def create_update_servercommunicationlinks(self):
        ...
        '''
        self.log("Creating / Updating the ServerCommunicationLinks instance {0}".format(self.resource_group_name))
    ...
    def delete_servercommunicationlinks(self):
        ...
        :return: True
        '''
        self.log("Deleting the ServerCommunicationLinks instance {0}".format(self.resource_group_name))
        try:
