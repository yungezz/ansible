...
EXAMPLES = '''
      - name: Create sample BackupLongTermRetentionPolicies
...
class AzureRMBackupLongTermRetentionPolicies(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not response:
            ...
            if self.state == 'absent':
                ...
                to_be_updated = True
                if to_be_updated:
                    self.log('Deleting BackupLongTermRetentionPolicies instance before update')
    ...
    def create_update_backuplongtermretentionpolicies(self):
        ...
        '''
        self.log("Creating / Updating the BackupLongTermRetentionPolicies instance {0}".format(self.server_name))
    ...
    def delete_backuplongtermretentionpolicies(self):
        ...
        :return: True
        '''
        self.log("Deleting the BackupLongTermRetentionPolicies instance {0}".format(self.server_name))
        try:
    ...
    def get_backuplongtermretentionpolicies(self):
        ...
        :return: deserialized BackupLongTermRetentionPolicies instance state dictionary
        '''
        self.log("Checking if the BackupLongTermRetentionPolicies instance {0} is present".format(self.server_name))
        found = False
        try:
