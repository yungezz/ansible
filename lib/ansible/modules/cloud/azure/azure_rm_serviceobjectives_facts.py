...
DOCUMENTATION = '''
---
module: azure_rm_serviceobjectives
version_added: "2.5"
...
EXAMPLES = '''
      - name: Create sample ServiceObjectives
        azure_rm_serviceobjectives:
'''
...
class AzureRMServiceObjectivesFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        '''
        self.log("Checking if the ServiceObjectives instance {0} is present".format(self.resource_group_name))
        found = False
        try:
