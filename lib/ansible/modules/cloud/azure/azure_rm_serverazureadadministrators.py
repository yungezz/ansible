...
EXAMPLES = '''
      - name: Create sample ServerAzureADAdministrators
...
class AzureRMServerAzureADAdministrators(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not response:
            ...
            if self.state == 'absent':
                ...
                to_be_updated = True
                if to_be_updated:
                    self.log('Deleting ServerAzureADAdministrators instance before update')
    ...
    def create_update_serverazureadadministrators(self):
        ...
        '''
        self.log("Creating / Updating the ServerAzureADAdministrators instance {0}".format(self.resource_group_name))
    ...
    def delete_serverazureadadministrators(self):
        ...
        :return: True
        '''
        self.log("Deleting the ServerAzureADAdministrators instance {0}".format(self.resource_group_name))
        try:
    ...
    def get_serverazureadadministrators(self):
        ...
        :return: deserialized ServerAzureADAdministrators instance state dictionary
        '''
        self.log("Checking if the ServerAzureADAdministrators instance {0} is present".format(self.resource_group_name))
        found = False
        try:
