...
EXAMPLES = '''
      - name: Create sample BackupLongTermRetentionVaults
...
class AzureRMBackupLongTermRetentionVaults(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not response:
            ...
            if self.state == 'absent':
                ...
                to_be_updated = True
                if to_be_updated:
                    self.log('Deleting BackupLongTermRetentionVaults instance before update')
    ...
    def create_update_backuplongtermretentionvaults(self):
        ...
        '''
        self.log("Creating / Updating the BackupLongTermRetentionVaults instance {0}".format(self.resource_group_name))
    ...
    def delete_backuplongtermretentionvaults(self):
        ...
        :return: True
        '''
        self.log("Deleting the BackupLongTermRetentionVaults instance {0}".format(self.resource_group_name))
        try:
    ...
    def get_backuplongtermretentionvaults(self):
        ...
        :return: deserialized BackupLongTermRetentionVaults instance state dictionary
        '''
        self.log("Checking if the BackupLongTermRetentionVaults instance {0} is present".format(self.resource_group_name))
        found = False
        try:
