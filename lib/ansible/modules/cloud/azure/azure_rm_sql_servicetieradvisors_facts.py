...
DOCUMENTATION = '''
---
module: azure_rm_sql_servicetieradvisors
version_added: "2.5"
...
EXAMPLES = '''
      - name: Create sample Sql
        azure_rm_sql_servicetieradvisors:
'''
...
class AzureRMServiceTierAdvisorsFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        '''
        self.log("Checking if the ServiceTierAdvisors instance {0} is present".format(self.server_name))
        found = False
        try:
