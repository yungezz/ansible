...
DOCUMENTATION = '''
---
module: azure_rm_replicationlinks
version_added: "2.5"
...
EXAMPLES = '''
      - name: Create sample ReplicationLinks
        azure_rm_replicationlinks:
'''
...
class AzureRMReplicationLinksFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        '''
        self.log("Checking if the ReplicationLinks instance {0} is present".format(self.server_name))
        found = False
        try:
