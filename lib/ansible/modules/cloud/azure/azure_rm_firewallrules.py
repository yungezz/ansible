...
EXAMPLES = '''
      - name: Create sample FirewallRules
...
class AzureRMFirewallRules(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not response:
            ...
            if self.state == 'absent':
                ...
                to_be_updated = True
                if to_be_updated:
                    self.log('Deleting FirewallRules instance before update')
    ...
    def create_update_firewallrules(self):
        ...
        '''
        self.log("Creating / Updating the FirewallRules instance {0}".format(self.resource_group_name))
    ...
    def delete_firewallrules(self):
        ...
        :return: True
        '''
        self.log("Deleting the FirewallRules instance {0}".format(self.resource_group_name))
        try:
    ...
    def get_firewallrules(self):
        ...
        :return: deserialized FirewallRules instance state dictionary
        '''
        self.log("Checking if the FirewallRules instance {0} is present".format(self.resource_group_name))
        found = False
        try:
