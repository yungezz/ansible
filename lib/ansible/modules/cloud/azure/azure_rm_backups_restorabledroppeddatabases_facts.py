...
DOCUMENTATION = '''
---
module: azure_rm_backups_restorabledroppeddatabases
version_added: "2.5"
...
EXAMPLES = '''
      - name: Create sample Backups
        azure_rm_backups_restorabledroppeddatabases:
'''
...
class AzureRMRestorableDroppedDatabasesFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        '''
        self.log("Checking if the RestorableDroppedDatabases instance {0} is present".format(self.resource_group_name))
        found = False
        try:
